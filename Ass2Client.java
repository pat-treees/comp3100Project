        ...
        public static void main(String[] args) {
            try {
                ...
                while(true){ 
                    ...
                    int flag = 1;
                    sendMessage("GETS Avail " + jobCore + " " + jobRAM + " " + jobDisk, dout);
                    ...
                    if(serverNumber == 0){
                        ...
                        serverInfoList = str.split(" ");

                        serverNumber = Integer.parseInt(serverInfoList[1]); //get the X (server type)

                    
                     //record all available servers one by one
